...
go
ALTER database db_aa59a5_projectapp set single_user with
rollback immediate;
go
ALTER database db_aa59a5_projectapp COLLATE croatian_CI_AS;
GO
Alter database db_aa59a5_projectapp set multi_user;
go
SELECT name, collation_name FROM sys.databases;
go
...
'2023-6-1 09:00:00','2023-8-1 09:00:00', 1, '2023-7-29 12:00:00', 1),
...
'2021-02-15 11:00:00','2021-03-28 17:00:00', 0,'2021-04-01 09:00:00',2),

('1.3 Izrada komunikacijske strategije','Komunikacijska strategija promocije eko-edukativne staze na potezu PP Drava-Mura mora uključivati zakup 
2x lokalnih, 1x regionalnih i 1x nacionalnih radio postaja, 2x nacionalne dnevne novine ....',
'2019-5-1 09:00','2019-6-1 11:00:00', 1,'2019-6-3 12:00:00',3),

('4.1. Koordinacijski sastanci','Izvršitelj je dužan napraviti zapisnik, držati potpisne liste te osigurati fotografski dokaz mjesečnih 
koordinacijskih sastanaka',
'2021-1-15 09:00:00','2021-1-16 11:00:00', 1,'2021-1-16 13:00:00',2),

('3.2. Redovno fotografiranje aktivnosti projekta','Na poziv Naručitelja Izvršitelj je dužan fotografirati ključne faze provedbe projekta, 
10x dostvljanje min rezolucije 4000x3000 300dpi',
'2020-4-17 8:00:00','2020-4-17 21:00:00', 1,'2020-4-18 12:00:00', 3),
...
'Videozapis o stručnom usavršavanju mentora kod poslodavaca - dvodnevna radionica isporuka u 1920x1080, audio EBU R 128 standard, 
trajanje 5 minuta, PAL',
'2023-9-9 09:00:00','2023-9-10 18:00:00', 1,'2023-9-13 15:00:00',2),
...
'2021-2-20 09:00:00','2021-2-20 12:10:00', 1,'2021-2-21 09:00:00',2);
